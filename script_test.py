...
class Interruption:
    ...
    def extraction_date_debut(fichier_out, regle):
    ...
    def extraction_date_fin(fichier_out, regle):
    ...
    def verifie_temps(fichier_out, regle):
        liste_verifie_temps = []
        liste_match_date_fin = Interruption.extraction_date_fin(fichier_out, regle)
        liste_match_date_debut = Interruption.extraction_date_debut(fichier_out, regle)
    ...
    def calcul_nb_interruption(fichier_out, regle1, regle2):
        interruption = 0
        liste_verifie_temps = Interruption.verifie_temps(fichier_out, regle2)
    ...
    def calcul_nb_interruption_par_an(fichier_out, regle1, regle2, regle3, annee):
        interruption = 0
        liste_verifie_temps = Interruption.verifie_temps(fichier_out, regle3)
        liste_verifie_nom = Interruption.verifie_nom(fichier_out)
        liste_match_prescrite = Interruption.extraction_dose_prescrite(fichier_out, regle1)
        liste_match_recu = Interruption.extraction_dose_recu(fichier_out, regle1)
    ...
    def calcul(fichier_out, regle1, regle2, regle3):
        interruption_liste = []
        print("Nombre d'interruption :")
        tot_interruption = Interruption.calcul_nb_interruption(fichier_out, regle1, regle3)
        if (tot_interruption > 0):
            for i in range(1955, 2050):
                interruption = Interruption.calcul_nb_interruption_par_an(fichier_out, regle1, regle2, regle3, i)
                if (interruption > 0):
...
Interruption.calcul(fichier_out, regle_doses, regle_annee, regle_date)
